...
<body>
    <div>
        ...
        $orden = $_POST['orden'];
        $categoriaEscapada = mysqli_real_escape_string($conexion, $categoria);
        ...
        $sql = "SELECT p.`ID_producto`, p.`nombre_producto`, p.`imagen_producto`, p.`precio`, p.`descuento`, p.`categoria`, AVG(v.valoracion) AS promedio_valoracion, COUNT(v.valoracion) AS cantidad_valoraciones
                FROM productos p
